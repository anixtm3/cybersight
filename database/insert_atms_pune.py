...
with open(r'C:\Users\SAINA20\Downloads\pune_atms.geojson', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
print(f"Inserted: {inserted} Pune ATMs")
cur.close()
conn.close()