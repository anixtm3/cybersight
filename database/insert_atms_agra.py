...
with open(r'C:\Users\SAINA20\Downloads\agra_atms.geojson', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
print(f"Inserted: {inserted} Agra ATMs")
cur.close()
conn.close()