...
with open(r'C:\Users\SAINA20\Downloads\patna_atms.geojson', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
print(f"Inserted: {inserted} Patna ATMs")
cur.close()
conn.close()